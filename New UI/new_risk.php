                    ...
                    <div class="create-list-login-panel center" style="max-width: 900px">
                        <div>
                            ...
                            <div class="row center">
                                <button style="position: relative; left:-7%;" class="btn" onclick="riskBack(<?php echo $id ?>)">Back</button>
                                <button style="position: relative; left:0%;" class="btn" onclick="riskSave(<?php echo $id ?>)">Save</button>
                                <button style="position: relative; left:7%;" class="btn" onclick="riskNext(<?php echo $id ?>)">Next</button>
                            </div>
