<html>
	...
	<body>
		...
		<form action="risk.php?" method="GET">
			...
			<div><textarea name="subjectCharacteristics" cols="100" rows="5" required></textarea></div>
			...
			<div><textarea name="recruitment" cols="100" rows="5" required></textarea></div>
			<div><p>D. To what extent and how are participants to be informed of research procedures before their participation?</p></div>
			<div><textarea name="partcipnatInfo" cols="100" rows="5" required></textarea></div>
			...
			<div><textarea name="researchMethod" cols="100" rows="5" required></textarea></div>
			...
			<div><textarea name="dataSources" cols="100" rows="5" required></textarea></div>
			<br/>
