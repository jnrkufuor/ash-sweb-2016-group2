...
<body>
	...
	<br><br>
		...
		?>
		<form style="margin-left:32%"action="updateBenefits.php" method="GET">
		<div style="height:350px" class="mainDiv">
			...
			<div><textarea name="participantConpensation" style="width:97%; height: 8%" required><?php echo $row['participantConpensation'] ?> </textarea></div>
			<div><p>B. What intrinsic benefit will participants / subjects / respondents receive? </p></div>
			<div><textarea name="participantBenefits" style="width:97%; height: 8%" required><?php echo $row['participantBenefits'] ?> </textarea></div>
			<br/>
			<br/>
			<div>Progress:<progress value="100" max="100"></progress> &nbsp; &nbsp; <input style="float:right; margin-left: 20px" type="submit" name="submit" value="Submit"><input style="float:right;" type="submit" name="save" value="Save As Draft"> <a style="float:right; margin-right: 40px"href="confidentiality.php?id=<?php echo $id ?>">Back</a> &nbsp;  </div> 
		</div><br><br>
		</form>
